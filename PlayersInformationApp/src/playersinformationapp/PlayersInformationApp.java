...
public class PlayerGUI extends Application {
    ...
    private void addPlayer() {
        ...
        try {
            ...
            playerId = Integer.parseInt(playerIdField.getText());
        } catch (NumberFormatException e) {
            showErrorAlert("Invalid input", "Age and Player ID must be numeric values.");
            return;
        }
        ...
        try {
            ...
            showErrorAlert("Database Error", "Failed to insert player information into the database.");
        }
    }
    ...
    private void deletePlayer() {
        ...
        if (selectedPlayer != null) {
            ...
            try {
                ...
                showErrorAlert("Database Error", "Failed to delete player information from the database.");
            }
        }
    }
